"""
Django settings for SchoolOABase project.
...
SECRET_KEY = 'cowwwxr#bo(_v9q5uu22v^jvt&yy*w=(o)sf%q-tz!rl6oa-$q'
...
ROOT_URLCONF = 'SchoolOABase.urls'

AUTH_USER_MODEL = 'system.Instructor'
...
WSGI_APPLICATION = 'SchoolOABase.wsgi.application'
